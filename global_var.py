...
D0 = [8e-6, 8e-5, 8e-5, 8e-5]  # 4e-8 # 8e-6 m^2/s ---------- коэф диффузии
LLL = [3.352e-6] * num_kan  # 3.352e-9 # коэф температуропроводности нержавеющей стали
UUU = [0.6, 0.8, 0.8, 0.9]  # 0.6 # eV ------- энергия связи
...
C1 = [10, 10, 10, 10]  # Моль / м^3 # концентрация внутри образца
# C2 = 6000  # 962.1169  # Моль / м^3 # концентрация погран слоя
C2 = [10, 10, 10, 10]  # Моль / м^3 # концентрация погран слоя
...
# DT1 = 0
# -----------------------------------
T_ac = [200 + 273, 500 + 273, 510 + 273, 520 + 273]  # попробуем ввести температуру активации каналов
