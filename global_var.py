...
D0 = [4e-7]  # 4e-8 # 8e-6 m^2/s ---------- коэф диффузии
LLL = [3.352e-9]  # 3.352e-9 # коэф температуропроводности нержавеющей стали
UUU = [0.6]  # 0.6 # eV ------- энергия связи
...
MaxNode = 700 + 1  # количесвто узлов
DR = Rad / MaxNode
Rl = Rad * 0.9
width_l = 0.05 * Rad
width_r = 0.05 * Rad
...
C1 = [80]  # Моль / м^3 # концентрация внутри образца
# C2 = 6000  # 962.1169  # Моль / м^3 # концентрация погран слоя
C2 = [280]  # Моль / м^3 # концентрация погран слоя
